...
import soa.sistemaderiegov3.Activities.DeviceListAdapter;
import soa.sistemaderiegov3.Activities.MainInformationActivity;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action))
            {
                ...
                if (state == BluetoothDevice.BOND_BONDED && prevState == BluetoothDevice.BOND_BONDING)
                {
                    ...
                    Intent i = new Intent(DeviceListActivity.this, MainInformationActivity.class);
